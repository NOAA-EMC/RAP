#BSUB -J %E%rap_dump_post_erly_%CYC%
#BSUB -o /%COM%/output/%ENVIR%/today/rap_dump_post_erly_%CYC%.o%J
#BSUB -e /%COM%/output/%ENVIR%/today/rap_dump_post_erly_%CYC%.o%J
#BSUB -L /bin/sh
#BSUB -q %QUEUE%
#BSUB -cwd /tmp
#BSUB -W 00:30
...
%manual
######################################################################
# Purpose:  Job to execute the 00Z RAP_E DATA DUMP post-processing
