#BSUB -J %E%rap_prep_erly_%CYC%
#BSUB -o /%COM%/output/%ENVIR%/today/rap_prep_erly_%CYC%.o%J
#BSUB -e /%COM%/output/%ENVIR%/today/rap_prep_erly_%CYC%.o%J
#BSUB -L /bin/sh
#BSUB -cwd /tmp
#BSUB -q %QUEUE%
#BSUB -W 00:30
...
%manual
######################################################################
# Purpose: Job to execute the 00Z RAP_E PREPBUFR data processing
######################################################################
