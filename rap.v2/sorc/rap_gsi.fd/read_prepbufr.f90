...
!$$$
  ...
  use aircraftobsqc, only: read_aircraft_t_bias,correct_aircraft_t 
...
!             Set usage variable              
              ...
              if ((kx>129.and.kx<140).or.(kx>229.and.kx<240) ) then
                 ...
                 if (tob.and.(kx>129.and.kx<140)) then  ! bias correction for aircraft T 
                    call correct_aircraft_t(c_station_id,plevs(k)*10.0_r_kind,obsdat(3,k)) 
                 endif
              endif
