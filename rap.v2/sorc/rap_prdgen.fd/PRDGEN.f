...
C    
      PARAMETER(IMAXIN=1200,JJMAXIN=900,JMAXIN=IMAXIN*JJMAXIN)
...
C
      print *, 'into prdgen '
      CALL W3TAGB('RAP_PRDGEN',2002,0183,0060,'NP22')
...
C    
      CALL READ_SORT_CTL (LCNTRL,MAXG,MAXF,FHR,K5PDS,MDLID,KGRIDA,
     &  TYPE,SCAL,NAMES,KGRID,IG1,KSMPR,KSMPO,ITILS,JTILS, 
     &  NEARN,NFILS,NGRDS,NFLDS,JPDS5,JPDS6,JPDS7,JPDS14,
     &  JPDS15,JPDS16,JPDS19,IOUTUN,IRET0)

      IF (IRET0.NE.0) THEN
        WRITE(6,*) ' READ_SORT_CTL RETURN CODE = ',IRET0
        CALL W3TAGE('RAP_PRDGEN')
        STOP 10
      ENDIF
...
C
       ...
       DO 30 N=1,NFLDS 
        print *, '30 loop ', N, JPDS5(N), IHAVE(N), NFILS(N)
C
