     ...
     &  JPDS5,JPDS6,JPDS7,JPDS14,JPDS15,JPDS16,JPDS19,IBUF,IHAVE,
     &  NBITL,RCBYTE,ISTART,IRET)
...
C$$$
      ...
      INTEGER JPDS5(MAXF),JPDS6(MAXF), JPDS7(MAXF),JPDS14(MAXF),
     &        JPDS15(MAXF),JPDS16(MAXF),JPDS19(MAXF) 
...
C
     ...
     &          +MOVA2I(IBUF(I1+12))
           ...
           IPDS14=MOVA2I(IBUF(I1+19)) 
           IPDS15=MOVA2I(IBUF(I1+20))
     ...
     &      + MOVA2I(IBUF(I+6)) 
         ...
         print *, 'NFLDS IN RSG ', NFLDS
         DO N=1,NFLDS
c          print *, ' RSG ', N, IPDS5, IPDS14, IPDS15, IPDS16
c          print *, 'RSGJ ', N, JPDS5(N), JPDS14(N), JPDS15(N), JPDS16(N)
          IF (IPDS5.EQ.JPDS5(N).AND.IPDS6.EQ.JPDS6(N).AND.
     &        IPDS7.EQ.JPDS7(N).AND.IPDS14.EQ.JPDS14(N).AND.
     &        IPDS15.EQ.JPDS15(N).AND.IPDS16.EQ.JPDS16(N).AND.
     &        IPDS19.EQ.JPDS19(N)) THEN
c           print *, 'MATCH! ', JPDS5(N)
           RCBYTE(N) = IRCBYTE
           ISTART(N) = I
           NBITL (N) = IBITL
c           print *, 'setting IHAVE to T ', N, IHAVE(N) 
           IHAVE(N)  = .TRUE.
c           print *, 'set IHAVE to T ', N, IHAVE(N) 
           RUSE=.TRUE.
          ENDIF
         ENDDO
