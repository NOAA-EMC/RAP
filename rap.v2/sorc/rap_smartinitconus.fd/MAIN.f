...
C
      PARAMETER(IM=2145,JM=1597,MAXLEV=50)
...
c   SPECIAL CALL OF THE FULL DATA SET BUT WITHOUT PRECIP
     ...
     X    T2,Q2,D2,U10,V10,VEG,BLI,WETFRZ,VIS,
     X    GUST,SNOD,REFC,TCLD,LCLD,MCLD,HCLD,BASEZ,DATE,FHR)
...
c      than 70% and RH at bottom of BL is less than 30
     ...
     X    downp,gridwx,mixhgt,mgtrans,lal,basez,snod)
