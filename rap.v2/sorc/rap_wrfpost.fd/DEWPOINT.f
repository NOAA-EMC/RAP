...
!    if(td(i,j).le.200.) then
    if (i.eq.335.and.j.eq.295) then
       print *,'TD(I,J),VP(I,J),A,B,DNTM1,W1,W2,JNT,TDP(JNT),TDP(JNT+1),i,j', &
                TD(I,J),VP(I,J),A,B,DNTM1,W1,W2,JNT,TDP(JNT),TDP(JNT+1),i,j
    endif
      ENDDO
      ENDDO
!
