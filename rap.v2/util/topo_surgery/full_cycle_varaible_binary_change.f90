subroutine full_cycle_varaible_binary_change(VarName,ifswap,iunit,nrecs,iunit_sfc,nrecs_sfc, &
...
if(1==1) then
  field3(695,1,1)=field3(695,1,1)-200
  field3(696,1,1)=field3(696,1,1)+200
  field3(697,1,1)=field3(697,1,1)+200
  field3(698,1,1)=field3(698,1,1)+200
  field3(699,1,1)=field3(699,1,1)+200
  field3(696,2,1)=field3(696,2,1)-200
endif
  write(*,*) 'after change'
  DO j=5,1,-1
     write(*,'(11f7.1)') (field3(i,j,1),i=692,702)
...
end subroutine full_cycle_varaible_binary_change
