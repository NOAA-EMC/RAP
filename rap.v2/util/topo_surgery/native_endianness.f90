...
!$$$ end documentation block
 ...
 subroutine to_r2i(ibuf4,dum3d_IKJ,im)
!
      integer, intent(in) :: im
      integer(4), intent(in) :: ibuf4(im)
      real(4), intent(out) :: dum3d_IKJ(im)

      integer:: i
      real(4)  rbufs
      integer  ibufs
      Equivalence(rbufs,ibufs)
 ...
 end subroutine to_r2i


 subroutine to_i2r(ibuf4,dum3d_IKJ,im)
!
      integer, intent(in) :: im
      integer(4), intent(out) :: ibuf4(im)
      real(4), intent(in) :: dum3d_IKJ(im)
