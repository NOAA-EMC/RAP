  subroutine write_bufr_CLAVR(nlon,nlat,index,w_pcld,w_tcld,w_frac,w_lwp,nlev_cld)
!$$$  subprogram documentation block
!                .      .    .                                       .
! subprogram:   write_bufr_CLAVR 
!   prgmmr: phofmann           org: essl/gsd                date: 2008-12-01
!   
! abstract: write CLAVR in RR grid into bufr
!   
! program history log:
!
!   input argument list:
...
! wait for GSI to fix this issue.
    ...
    write(6,*) 'write_bufr_CLAVR, DONE: write columns:',numref

end subroutine  write_bufr_CLAVR
