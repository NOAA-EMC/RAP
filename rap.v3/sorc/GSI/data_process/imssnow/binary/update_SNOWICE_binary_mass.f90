subroutine update_SNOWICE_binary_mass(snowiceRR, xland, luse, nlon, nlat)
!$$$  documentation block
!                .      .    .                                       .
...
!tgs 13 April 2012 - change 276K into 280K
...
!
  ...
  call mpi_file_write_at(iunit,file_offset(index+1),field2,  &
