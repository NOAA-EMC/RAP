program full_cycle_binary_mass
!$$$  documentation block
!                .      .    .                                       .
!   full_cycle_surface_netcdf_mass: read some variables from one wrf forecast
!        in mass binary and write to another binary mass file  
!
...
!  ------ cycle SNOW
  VarName='SNOW'
  call full_cycle_varaible_binary(VarName,iunit,nrecs,iunit_sfc,nrecs_sfc, &
...
!  ------ cycle TSK, SOILT1
     call update_binary_mass_snowT(iunit,nrecs,iunit_sfc,nrecs_sfc, &
           varname_all,memoryorder_all,domainend_all,file_offset,      &
           varname_all_sfc,memoryorder_all_sfc,domainend_all_sfc,file_offset_sfc)
...
end program full_cycle_binary_mass
