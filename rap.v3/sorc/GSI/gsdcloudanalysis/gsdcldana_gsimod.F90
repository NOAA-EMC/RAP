...
! !PUBLIC ROUTINES:
   ...
   public gsdcldana_gsimain_initialize
   public gsdcldana_gsimain_run
   public gsdcldana_gsimain_finalize
...
! ! INTERFACE:
  ...
  subroutine gsdcldana_gsimain_initialize
...
! If this is a wrf regional run, then run interface with wrf
  update_pint=.false.
!gsdcldana  if (regional) call convert_regional_guess(mype,ctph0,stph0,tlm0)
...
! Initialize values in aeroinfo
  ...
  end subroutine gsdcldana_gsimain_initialize
...
! ! INTERFACE:
  ...
  subroutine gsdcldana_gsimain_run(init_pass,last_pass)
...
! Call the main gsi driver routine
  call gsdcldana_gsisub(mype, init_pass_,last_pass_)

  end subroutine gsdcldana_gsimain_run
...
! ! IROUTINE: gsimain_finalize
 ...
 subroutine gsdcldana_gsimain_finalize
...
! Done with GSI.
 ...
 end subroutine gsdcldana_gsimain_finalize

 end module gsdcldana_gsimod
