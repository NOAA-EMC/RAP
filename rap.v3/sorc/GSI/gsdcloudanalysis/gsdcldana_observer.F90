...
!$$$
  ...
  use gsdcldana_read_obsmod, only: gsdcldana_read_obs
...
! public observer_guess_init     ! RT: doesn't really belong here
  public gsdcldana_observer_init
  public gsdcldana_observer_set
  public gsdcldana_observer_run
  public gsdcldana_observer_finalize
! public observer_guess_finalize ! RT: doesn't really belong here
  public ndata

  integer(i_kind),allocatable,dimension(:,:):: ndata

  interface gsdcldana_observer_guess_init
     module procedure guess_init_
  end interface
  interface gsdcldana_observer_init
     module procedure init_
  end interface
  interface gsdcldana_observer_set
     module procedure set_
  end interface
  interface gsdcldana_observer_run
     module procedure run_
  end interface
  interface gsdcldana_observer_finalize
     module procedure final_
  end interface
  interface gsdcldana_observer_guess_finalize
...
!    Read observations from data files
     call gsdcldana_read_obs(ndata,mype)
...
!mhu  call destroy_jfunc

! End of routine
end subroutine guess_final_

end module gsdcldana_observermod
