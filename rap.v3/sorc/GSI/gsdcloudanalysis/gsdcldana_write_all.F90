...
subroutine gsdcldana_write_all(increment,mype)
...
! !USES:
  ...
  use gsdcldana_regional_io, only: gsdcldana_write_regional_analysis
...
! Regional output
  if (regional) call gsdcldana_write_regional_analysis(mype)
...
! End of global block
  ...
  return
end subroutine gsdcldana_write_all
