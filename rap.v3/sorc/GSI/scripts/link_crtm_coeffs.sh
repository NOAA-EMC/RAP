...
#
# $Id: link_crtm_coeffs.sh 51697 2015-02-18 17:51:24Z Michael.Lueken@noaa.gov $

script_id()
{
  REVISION='$Revision: 51697 $'
  LAST_CHANGED_DATE='$LastChangedDate: 2015-02-18 17:51:24 +0000 (Wed, 18 Feb 2015) $'
  echo
