...
! open(outerr,file='berror_stats_global_RR_tune_IBM',form='unformatted',status='new',convert='big_endian')
  open(outerr,file='rap_berror_stats_global_RR_tune_IBM',form='unformatted',status='new',convert='big_endian')
  open(inerr,file='rap_berror_stats_global_RR_tune',form='unformatted',status='old')
