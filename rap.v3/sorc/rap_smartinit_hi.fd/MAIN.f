...
C
     ...
     X    blr(im,jm),t2(im,jm),q2(im,jm),bli(im,jm), 
...
c   SPECIAL CALL OF THE FULL DATA SET BUT WITHOUT PRECIP
     ...
     X    T2,Q2,D2,U10,V10,COAST,BLI,WETFRZ,VIS,GUST,
     X    REFC,TCLD,LCLD,MCLD,HCLD,BASEZ,CEIL,DATE,FHR)
        print *, 'after getgrib'
...
c      need to prevent values like 2E-43 which cause w3fi63 to fail
...
c      than 70% and RH at bottom of BL is less than 30
     ...
     X    downp,gridwx,mixhgt,mgtrans,lal,ceil)
