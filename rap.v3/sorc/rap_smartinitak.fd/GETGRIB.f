     ...
     X   T2,Q2,D2,U10,V10,COAST,BLI,WETFRZ,VIS,GUST,DEPSN,
     X   REFC,TCLD,LCLD,MCLD,HCLD,BASEZ,CEIL,VALIDPT,DATE,IFHR)
C$$$  SUBPROGRAM DOCUMENTATION BLOCK
C                .      .    .
C SUBPROGRAM:    GETGRIB    CREATES NDFD FILES 
C   PRGRMMR: MANIKIN           ORG: W/NP22     DATE: 11-10-10
C
C ABSTRACT:
C   .
C
C PROGRAM HISTORY LOG:
C   10-10-14  G MANIKIN  - ADAPT CODE TO RAPID REFRESH
C
...
C     NONE
      ...
      PARAMETER(ILIM=1649,JLIM=1105,MAXLEV=50)
...
C
     ...
     x  U10(ILIM,JLIM),V10(ILIM,JLIM),TCLD(ILIM,JLIM),CEIL(ILIM,JLIM),
     ...
     x  COAST(ILIM,JLIM),REFC(ILIM,JLIM),GUST(ILIM,JLIM)
