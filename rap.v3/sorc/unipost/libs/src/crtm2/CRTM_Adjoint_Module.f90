...
!
! CONTAINS:
!       CRTM_Adjoint:  Function that calculates the adjoint of top-of-atmosphere
...
MODULE CRTM_Adjoint_Module
  ...
  '$Id: CRTM_Adjoint_Module.f90,v 1.5.2.8 2005/10/20 19:58:31 paulv Exp $'
...
! $State: Exp $
!
! $Log: CRTM_Adjoint_Module.f90,v $
! Revision 1.5.2.8  2005/10/20 19:58:31  paulv
! - Only forward model options arguments are now accepted.
!
! Revision 1.5.2.7  2005/10/11 21:41:37  paulv
! - Updated header documentation.
! - Added Options and Options_AD optional structure arguments.
! - Now testing for user FWD and AD emissivity and direct reflectivity
!   with respect to the Options and Options_AD arguments.
...
!   FWD Options and AD Options_AD optional arguments. This was done to
!   prevent a profile-independent test inside the profile loop and to allow
!   the optional arguments to be indexed as needed.
! - Filling the FWD and AD SfcOptics structures as needed according to the
!   contents of the optional Options and Options_AD arguments.
! - AtmOptics AOV internal variable structure.
!   o Added AOV internal variable type declaration
!   o Added AOV argument to FWD and AD AtmOptics calls.
! - RTSolution RTV internal variable structure.
!   o Added RTV internal variable type declaration
!   o Added RTV argument to FWD and AD RTSolution calls.
...
!   CRTM_RTSolution.f90)
!
! Revision 1.5.2.6  2005/09/15 14:27:55  qliu
! -- Added error status checking.
!
! Revision 1.5.2.5  2005/09/12 13:46:55  qliu
! -- Modification for fitting CRTM_Interpolation.
!
! Revision 1.5.2.4  2005/08/24 12:39:03  qliu
! -- Deleted a unused variable.
!
! Revision 1.5.2.3  2005/08/23 22:06:04  qliu
! -- Deleted unused variable.
!
! Revision 1.5.2.2  2005/08/23 21:54:26  qliu
! -- Deleted unused variable.
!
! Revision 1.5.2.1  2005/08/23 21:22:36  qliu
