...
!                                     over a snow surface.
!
!       Compute_IR_Snow_SfcOptics_TL: Function to compute the tangent-linear
!                                     surface emissivity and reflectivity at
!                                     infrared frequencies over a snow surface.
!
!       Compute_IR_Snow_SfcOptics_AD: Function to compute the adjoint surface
...
MODULE CRTM_IR_Snow_SfcOptics
  ...
  '$Id: CRTM_IR_Snow_SfcOptics.f90,v 1.2.2.2 2005/09/21 16:56:32 yhan Exp $'
...
!----------------------------------------------------------------------------------
  ...
  FUNCTION Compute_IR_Snow_SfcOptics( Surface,       &  ! Input
    ...
    ! -- Map the 16 snow surface types defined in Surface_Define module
    !    to the two snow surface types (2 - old snow; 3 - fresh snow) used 
    !    in this model  
    INTEGER,       PARAMETER :: TYPE_MAP(N_VALID_SNOW_TYPES) = &
                 (/2, 2, 3, 3, 2, 2, 2, 2, 3, 3, 3, 2, 2, 3, 2, 2/)
...
! $State: Exp $
!
! $Log: CRTM_IR_Snow_SfcOptics.f90,v $
! Revision 1.2.2.2  2005/09/21 16:56:32  yhan
! --- Changed the parameter array element Type_Map(4): POWDER_SNOW is now
!     mapped to NEW_SNOW
!
! Revision 1.2.2.1  2005/09/02 17:39:57  qliu
