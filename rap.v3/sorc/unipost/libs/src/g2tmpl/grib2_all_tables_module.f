...
!
!
!     subroutine g2sec4_temp0(icatg,iparm,typ_gen_proc_key,bckgnd_gen_proc_id,      &
...
! 2010-03-01  V. Krishna Kumar
!
! USAGE:    CALL g2sec5_temp0(dec_scale_fac,type_of_field,ifield5)
!   INPUT ARGUMENT LIST:
!     dec_scale_fac  - Decimal scale factor (D)
!     type_of_field - Type of original field values (see Code Table 5.1)
!
!   OUTPUT ARRAY:
...
!
!
     subroutine g2sec5_temp40(dec_scale_fac,bin_scale_fac,tlnumbits,type_of_field,     &
                               type_of_compression,ifield5,len,fld)
!
!$$$  SUBPROGRAM DOCUMENTATION BLOCK
!                .      .    .                                       .
...
! PROGRAM HISTORY LOG:
! 2010-03-01  V. Krishna Kumar
! 2010-04-07  Jun Wang    set total number of bits from data fld
!
...
!
!$$$
     integer(4),intent(in) :: bin_scale_fac,dec_scale_fac,tlnumbits,len
     character(*),intent(in) :: type_of_field,type_of_compression
     integer(4),intent(inout) :: ifield5(7)
     real,intent(in)       :: fld(len)
!
!--- local variable
     integer(4) :: value,ierr
