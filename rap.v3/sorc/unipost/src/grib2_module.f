...
!
       ...
       ifield3(10) = latstart*1000   !latitude of first grid point
       if(lonstart <0) then 
         ifield3(11) = (360000 + lonstart)*1000
       else 
         ifield3(11) = lonstart*1000   !longitude of first grid point
       end if
       ifield3(12) = 8          !Resolution and component flags
       ifield3(13) = TRUELAT1*1000
       if(STANDLON < 0) then 
         ifield3(14) = (360000 + STANDLON)*1000
       else 
         ifield3(14) = STANDLON*1000   !longitude of meridian parallel to
!                                       y-xaxis along which latitude increases
       end if
       ifield3(15) = DXVAL*1000
       ifield3(16) = DYVAL*1000
       IF(TRUELAT1>0)then
        ifield3(17) = 0
       else
       ...
       ifield3(18) = 64
       ifield3(19) = TRUELAT1*1000   !first latitude from the pole at which the secant cone cuts the sphere
       ifield3(20) = TRUELAT2*1000   !second latitude from the pole at which the secant cone cuts the sphere
