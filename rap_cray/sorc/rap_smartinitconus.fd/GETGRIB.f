     ...
     X   REFC,TCLD,LCLD,MCLD,HCLD,BASEZ,CEIL,MSLP,DATE,IFHR)
...
C   11-09-30  G MANIKIN  - ADAPT CODE TO RAPID REFRESH 
C
...
C     NONE
      ...
      PARAMETER(ILIM=2345,JLIM=1597,MAXLEV=50)
...
C
     ...
     x  MSLP(ILIM,JLIM),CEIL(ILIM,JLIM)
...
c sea level pressure 
     ...
     X           KPDS,KGDS,MASK,GRID,IRET)
      IF(IRET.EQ.0) THEN
        ...
        ENDDO
      ELSE
        WRITE(6,*)' COULD NOT UNPACK SEA LEVEL PRESSURE'
         ISTAT = IRET
       RETURN
      ENDIF
