...
if [ ! -r guess.out ]; then
    echo 'Warning: no first guess is available'
    echo 'please try a cycle divisible by 3'
#   exit
fi

# if the cycle is 09 or 21, we should have the last 1-hr forecast
#   from the partial cycle available
if [[ ${cyc} -eq '09' || ${cyc} -eq '21' ]]; then
  PCYC_TIME=`$NDATE -1 $START_TIME`
  if [ -r ${RAPGES_PCYC}/rap_${PCYC_TIME}f001 ]; then
    cp ${RAPGES_PCYC}/rap_${PCYC_TIME}f001 ./wrf_inout
    echo " Cycle ${PDY}${cyc}: GSI started with PCYC guess rap_${PCYC_TIME}f001"
  fi
fi
...
if [ ! -r wrf_inout ]; then
#    targetsize=6858968708  # RAPv5
    targetsize2=6871551620  # rapv5 size working dir on Dell2
    targetsize=6854865028  # RAPv5
    counter=1
    while [[ $counter -lt 22 ]]; do
     counterhr=$counter
     typeset -Z2 counterhr
...
#     if [ $filesize -eq $targetsize ]; then
      if [[ $filesize -eq $targetsize  || $filesize -eq $targetsize2 ]]; then
       ...
       echo " Cycle ${PDY}${cyc}: GSI background=rap_${FCYC_TIME}f0$counterhr"
       break
      else 
        export subject="Corrupt RAP guess file!"
        export maillist=${maillist:-'nco.spa@noaa.gov,geoffrey.manikin@noaa.gov,benjamin.blake@noaa.gov'}
        echo "Filesize of ${RAPGES_FCYC}/rap_${FCYC_TIME}f0$counterhr $filesize is not right!">>mailmsg 
...
## cycle surface variables
      ...
      while [[ $counter -lt 40 ]]; do
        ...
        FCYC_TIME=`$NDATE -${counter} $START_TIME`
        if [ -r ${RAPGES_FCYC}/rap_${FCYC_TIME}f0$counterhr ]; then
          echo " Cycle surface fields based on rap_${FCYC_TIME}f0$counterhr"
...
icnt=1
  while [ $icnt -lt 1000 ]
  do
    if [ -r ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.prepbufr.tm00 ]
    then
      ln -s ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.prepbufr.tm00 ./prepbufr
      break
    else
      icnt=$((icnt + 1))
      sleep 5
...
#if [ -r "${PREPDIR}/rap.${PDY}/rap.t${cyc}z.radwnd.tm00.bufr_d" ]; then
#  ln -s ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.radwnd.tm00.bufr_d ./radarbufr
#else
#  echo "Warning: ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.radwnd.tm00.bufr_d is not available"
#fi
...
#add SATWND data
if [ -r "${PREPDIR}/rap.${PDY}/rap.t${cyc}z.satwnd.tm00.bufr_d" ]; then
  ln -s ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.satwnd.tm00.bufr_d ./satwndbufr
else
  echo "Warning: ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.satwnd.tm00.bufr_d is not available"
fi

#add radiance data
if [ -r "${PREPDIR}/rap.${PDY}/rap.t${cyc}z.1bamua.tm00.bufr_d" ]; then
  ln -s ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.1bamua.tm00.bufr_d ./amsuabufr
else
  echo "Warning: ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.1bamua.tm00.bufr_d is not available"
fi

if [ -r "${PREPDIR}/rap.${PDY}/rap.t${cyc}z.1bamub.tm00.bufr_d" ]; then
  ln -s ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.1bamub.tm00.bufr_d ./amsubbufr
else
  echo "Warning: ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.1bamub.tm00.bufr_d is not available"
fi

if [ -r "${PREPDIR}/rap.${PDY}/rap.t${cyc}z.1bhrs3.tm00.bufr_d" ]; then
  ln -s ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.1bhrs3.tm00.bufr_d ./hirs3bufr
else
  echo "Warning: ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.1bhrs3.tm00.bufr_d is not available"
fi

if [ -r "${PREPDIR}/rap.${PDY}/rap.t${cyc}z.1bhrs4.tm00.bufr_d" ]; then
  ln -s ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.1bhrs4.tm00.bufr_d ./hirs4bufr
else
  echo "Warning: ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.1bhrs4.tm00.bufr_d is not available"
fi

if [ -r "${PREPDIR}/rap.${PDY}/rap.t${cyc}z.1bmhs.tm00.bufr_d" ]; then
  ln -s ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.1bmhs.tm00.bufr_d ./mhsbufr
else
  echo "Warning: ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.1bmhs.tm00.bufr_d is not available"
fi

#new platforms
if [ -r "${PREPDIR}/rap.${PDY}/rap.t${cyc}z.sevcsr.tm00.bufr_d" ]; then
  ln -s ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.sevcsr.tm00.bufr_d ./seviribufr
else
  echo "Warning: ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.sevcsr.tm00.bufr_d is not available"
fi

if [ -r "${PREPDIR}/rap.${PDY}/rap.t${cyc}z.atms.tm00.bufr_d" ]; then
  ln -s ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.atms.tm00.bufr_d ./atmsbufr
else
  echo "Warning: ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.atms.tm00.bufr_d is not available"
fi

if [ -r "${PREPDIR}/rap.${PDY}/rap.t${cyc}z.cris.tm00.bufr_d" ]; then
  ln -s ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.cris.tm00.bufr_d ./crisbufr
else
  echo "Warning: ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.cris.tm00.bufr_d is not available"
fi

if [ -r "${PREPDIR}/rap.${PDY}/rap.t${cyc}z.airsev.tm00.bufr_d" ]; then
  ln -s ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.airsev.tm00.bufr_d ./airsbufr
else
  echo "Warning: ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.airsev.tm00.bufr_d is not available"
fi

if [ -r "${PREPDIR}/rap.${PDY}/rap.t${cyc}z.ssmisu.tm00.bufr_d" ]; then
  ln -s ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.ssmisu.tm00.bufr_d ./ssmisbufr
else
  echo "Warning: ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.ssmisu.tm00.bufr_d is not available"
fi

if [ -r "${PREPDIR}/rap.${PDY}/rap.t${cyc}z.mtiasi.tm00.bufr_d" ]; then
  ln -s ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.mtiasi.tm00.bufr_d ./iasibufr
else
  echo "Warning: ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.mtiasi.tm00.bufr_d is not available"
fi

#add goes sounder data
if [ -r "${PREPDIR}/rap.${PDY}/rap.t${cyc}z.goesnd.tm00.bufr_d" ]; then
  ln -s ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.goesnd.tm00.bufr_d ./gsnd1bufr
else
  echo "Warning: ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.goesnd.tm00.bufr_d is not available"
fi

#add rars data
if [ -r "${PREPDIR}/rap.${PDY}/rap.t${cyc}z.esamua.tm00.bufr_d" ]; then
  ln -s ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.esamua.tm00.bufr_d ./amsuabufrears
else
  echo "Warning: ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.esamua.tm00.bufr_d is not available"
fi

if [ -r "${PREPDIR}/rap.${PDY}/rap.t${cyc}z.esmhs.tm00.bufr_d" ]; then
  ln -s ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.esmhs.tm00.bufr_d ./mhsbufrears
else
  echo "Warning: ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.esmhs.tm00.bufr_d is not available"
fi

#new rars
if [ -r "${PREPDIR}/rap.${PDY}/rap.t${cyc}z.esatms.tm00.bufr_d" ]; then
  ln -s ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.esatms.tm00.bufr_d ./atmsbufrears
else
  echo "Warning: ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.esatms.tm00.bufr_d is not available"
fi

if [ -r "${PREPDIR}/rap.${PDY}/rap.t${cyc}z.escrsf.tm00.bufr_d" ]; then
  ln -s ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.escrsf.tm00.bufr_d ./crisfsbufrears
else 
  echo "Warning: ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.escrsf.tm00.bufr_d is not available"
fi

if [ -r "${PREPDIR}/rap.${PDY}/rap.t${cyc}z.esiasi.tm00.bufr_d" ]; then
  ln -s ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.esiasi.tm00.bufr_d ./iasibufrears
else 
  echo "Warning: ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.esiasi.tm00.bufr_d is not available"
fi

#new directbroadcast
fileobs=${PREPDIR}/rap.${PDY}/rap.t${cyc}z.atmsdb.tm00.bufr_d
if [ -r "${fileobs}" ]; then
...
fileobs=${PREPDIR}/rap.${PDY}/rap.t${cyc}z.crsfdb.tm00.bufr_d
if [ -r "${fileobs}" ]; then
...
fileobs=${PREPDIR}/rap.${PDY}/rap.t${cyc}z.iasidb.tm00.bufr_d
if [ -r "${fileobs}" ]; then
  ln -s ${fileobs} ./iasibufr_db
else
  echo "Warning: ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.iasidb.tm00.bufr_d is not available"
fi

fileobs=${PREPDIR}/rap.${PDY}/rap.t${cyc}z.crisf4.tm00.bufr_d
##for rapv5 updates   
if [ -r "${fileobs}" ]; then
...
fileobs=${PREPDIR}/rap.${PDY}/rap.t${cyc}z.gsrcsr.tm00.bufr_d
if [ -r "${fileobs}" ]; then
...
mv ./radstat.rap radstat.rap_${PDY}${cyc}
cp ./radstat.rap_${PDY}${cyc} ${RAPGES_SATBIAS}/
mv ./satbias_out satbias_out_${PDY}${cyc}
cp ./satbias_out_${PDY}${cyc} ${RAPGES_SATBIAS}/
mv ./satbias_pc.out satbias_pc.out_${PDY}${cyc}
cp ./satbias_pc.out_${PDY}${cyc} ${RAPGES_SATBIAS}/
...
if [ ${cyc} -eq ${trim_snow} ]; then
  if [ -r "${PREPDIR}/rap.${PDY}/rap.t${cyc}z.imssnow.grib2" ]; then
     echo "trim snow based on imssnow "
     cp  ${PREPDIR}/rap.${PDY}/rap.t${cyc}z.imssnow.grib2 ./imssnow2
     cp  ${FIXrap}/rap_geo_em.d01.nc ./geo_em.d01.nc
     cp  ${EXECrap}/rap_process_imssnow .

     runline="mpiexec -n 1 -ppn 1 ./rap_process_imssnow"
     $runline >> $DATA/$pgmout 2>errfile
     export err=$?; err_chk
  else
    echo "${PREPDIR}/rap.${PDY}/rap.t${cyc}z.imssnow.grib2 does not exist!!"
    echo "no snow file available at for ${cyc}z cycle!!!!"
  fi
else
