...
wrf_exe=${1:-rap_wrfarw_fcst} # name of wrf executable in local directory
...
#    mpiexec -n 1 cat "$scaling_frequencies" > scaling_frequencies
...
#runline="mpiexec -n 912 -ppn 64  --cpu-bind core --depth 2 ./rap_wrfarw_fcst"
runline="mpiexec -n 912 -ppn 64 --cpu-bind core --depth 2 ./rap_wrfarw_fcst"
$runline
export err=$?; err_chk
